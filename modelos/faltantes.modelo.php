...
class ModeloFaltantes{
    ...
    static public function mdlMostrarFaltantes($tabla, $item, $valor){
        ...
        $sql = "SELECT c.nombreconsultor as consultor, s.nombresede as sede, d.imeidispositivo as imei, r.fecha_asignacion as fecha_asignacion, r.fecha_recepcion as fecha_recepcion, r.accesorios_entregados as entregado, r.accesorios_recuperados as recuperado, CONCAT('[', r.accesorios_entregados,',', r.accesorios_recuperados,']') as acc  FROM $tabla r 
