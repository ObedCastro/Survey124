        ...
        <div class="row">
            ...
            <div class="card card-plain mt-8">
              ...
              <div class="card-body">
                <form method="post" role="form">
                  ...
                  <div class="mb-3">
                    <input name="ingPassword" type="password" class="form-control" placeholder="Contraseña" aria-label="Password" aria-describedby="password-addon">
                  </div>
          ...
          <div class="col-md-6">
            <div class="oblique position-absolute top-0 h-100 d-md-block d-none me-n8">
              <div class="oblique-image bg-cover position-absolute fixed-top ms-auto h-100 z-index-0 ms-n6" style="background-image:url('vistas//assets/img/curved-images/curved7.jpg')"></div>
            </div>
          </div>
        </div>
      </div>
